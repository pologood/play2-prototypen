...
import models.common.LinkedAccount;
...
public class MyUsernamePasswordAuthProvider
	...
	protected String onLoginUserNotFound(final Context context) {
		context.flash()
				.put(controllers.common.Application.FLASH_ERROR_KEY,
	...
	protected Body getVerifyEmailMailingBodyAfterSignup(final String token,
		...
		final String html = getEmailTemplate(
				"views.html.common.account.email.verify_email", langCode, url, token,
				user.name, user.email);
		final String text = getEmailTemplate(
				"views.txt.common.account.email.verify_email", langCode, url, token,
				user.name, user.email);
