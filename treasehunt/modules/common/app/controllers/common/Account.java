...
//import views.html.common.account.*;
...
public class Account extends Controller {
	...
	public static Result link() {
		...
		return ok(views.html.common.account.link.render());
	}

//	Not supported yet
//	@Restrictions({@And(Roles.ROLE_ADMIN), @And(Roles.ROLE_PLAYER)})
	@SubjectPresent
...
//	@Restrict(@Group(Application.USER_ROLE))
	...
	public static Result changePassword() {
		...
		if (!u.emailValidated) {
			return ok(views.html.common.account.unverified.render());
		} else {
			return ok(views.html.common.account.password_change.render(PASSWORD_CHANGE_FORM));
		}
	}
...
//	@Restrict(@Group(Application.USER_ROLE))
	...
	public static Result doChangePassword() {
		...
		if (filledForm.hasErrors()) {
			...
			return badRequest(views.html.common.account.password_change.render(filledForm));
		} else {
			final User user = Application.getLocalUser(session());
	...
	public static Result askLink() {
		...
		return ok(views.html.common.account.ask_link.render(ACCEPT_FORM, u));
	}
	...
	public static Result doLink() {
		...
		if (filledForm.hasErrors()) {
			// User did not select whether to link or not link
			return badRequest(views.html.common.account.ask_link.render(filledForm, u));
		} else {
			// User made a choice :)
	...
	public static Result askMerge() {
		...
		return ok(views.html.common.account.ask_merge.render(ACCEPT_FORM, aUser, bUser));
	}
	...
	public static Result doMerge() {
		...
		if (filledForm.hasErrors()) {
			...
			return badRequest(views.html.common.account.ask_merge.render(filledForm, aUser, bUser));
		} else {
			// User made a choice :)
