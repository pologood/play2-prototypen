...
import models.common.TokenAction;
import models.common.TokenAction.Type;
import models.common.User;
import play.data.Form;
import play.i18n.Messages;
import play.mvc.Controller;
import play.mvc.Result;
import providers.common.MyLoginUsernamePasswordAuthUser;
import providers.common.MyUsernamePasswordAuthProvider;
import providers.common.MyUsernamePasswordAuthProvider.MyIdentity;
import providers.common.MyUsernamePasswordAuthUser;
...
public class Signup extends Controller {
	...
	public static Result unverified() {
		...
		return ok(views.html.common.account.signup.unverified.render());
	}
	...
	public static Result forgotPassword(final String email) {
		...
		return ok(views.html.common.account.signup.password_forgot.render(form));
	}
	...
	public static Result doForgotPassword() {
		...
		if (filledForm.hasErrors()) {
			...
			return badRequest(views.html.common.account.signup.password_forgot.render(filledForm));
		} else {
			...
			return redirect(controllers.common.routes.Application.index());
		}
	}
	...
	public static Result resetPassword(final String token) {
		...
		if (ta == null) {
			return badRequest(views.html.common.account.signup.no_token_or_invalid.render());
		}

		return ok(views.html.common.account.signup.password_reset.render(PASSWORD_RESET_FORM
	...
	public static Result doResetPassword() {
		...
		final Form<PasswordReset> filledForm = PASSWORD_RESET_FORM
				.bindFromRequest();
		if (filledForm.hasErrors()) {
			return badRequest(views.html.common.account.signup.password_reset.render(filledForm));
		} else {
			...
			return redirect(controllers.common.routes.Application.login());
		}
	}

	public static Result oAuthDenied(final String getProviderKey) {
		com.feth.play.module.pa.controllers.Authenticate.noCache(response());
		return ok(views.html.common.account.signup.oAuthDenied.render(getProviderKey));
	}

	public static Result exists() {
		com.feth.play.module.pa.controllers.Authenticate.noCache(response());
		return ok(views.html.common.account.signup.exists.render());
	}
